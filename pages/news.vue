                                    ...
                                    <div>
                                        <ul class="list-none text-blue-600 dark:text-blue-500 my-3">
                                            <li v-for="link in news.links" :key="link.url">
                                                <NuxtLink :to="link.url" :target="link.isExternal ? '_blank' : '_self'">
                                                    {{ link.text
                                                    }}
                                                </NuxtLink>
                                            </li>
...
const news = [
    ...
    },
    {
        ...
        description:
            "Jacob Bertilsson's and Anders Dahlberg's collaborative project Skogssvamp has been awarded a two year project grant from Skogssällskapet.",
        links: [
            {
    ...
    },
    {
        ...
        thumbnail: "",
        description:
            "The Skogssvamp project was presented at the Oxford Real Farming Conference as part of the Investigative Ecologies event.",
        links: [
            {
        ...
        avatar: "i-heroicons-link-solid",
        iframe:
            "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/1433703880&color=%23333230&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true",
    },
    {
        id: "CRA",
        ...
        description:
            "The MA Reseach Architecture degree show is open between 29/09 - 06/10, St James Hatcham Church, 25 st James's London SE14 6AD.",
        links: [
            {
    ...
    },
    {
        ...
        description:
            ' "Carceral Geographies second element sees a presentation from members of the Carceral Time Working Group, a collective of Goldsmith’s Architecture MA students who have conducted a critical research appraisal of Holloway Prison, formerly the largest women’s prison in Europe." ',
        links: [
            {
    ...
    },
    {
        ...
        thumbnail: "FA.png",
        description:
            "The investigation 'Environmental racism in death alley, Louisiana' by Forensic Architecture has been published.",
        links: [
            {
    ...
    },
    {
        ...
        description:
            ' "IRL é RL is a project by the research platform Effondrement des Alpes, invited to the macLYON from May to July 2021." ',
        links: [
            {
    ...
    },
    {
        ...
        description:
            "The video work Travel Park was included in the ALL INN exhibition at Het Hem in Zaandam, the multi-academy fine-art graduation show in the Netherlands.",
        links: [
            {
    ...
    },
    {
        ...
        description:
            ' "Hello, this Friday is the opening of a weekend-long exhibition by Rotterdam-based artist @jacobertilsson. It is also his last weekend in Vancouver before heading back to Europe. We hope you can join us ~ " ',
        links: [
            {
