<template>
  <div class="hidden">
    <NuxtImg
      src="images/ground_floor_05.png"
      width="700"
      format="webp"
      class="w-full"
    />
  ...
  <div class="pb-10">
    ...
    <div class="relative transition-all" :style="{ height: computedHeight }">
      ...
      <transition name="fade">
        <div
          v-if="!isGridView && isCarouselViewVisible"
          key="carousel"
          class="group"
          ref="carouselRef"
        >
    ...
    <div class="grid lg:grid-cols-4 grid-cols-1 mt-3 gap-y-3 lg:gap-3">
      ...
      >
        ...
        <p>
          Subplot_01ew is a first output from an ongoing research project
          concerning edelweiss conservation. The series is meant as a
          provocation for multi-layered conversations around conservation and
          identity.
          <br /><br />
          The installation was exhibited at the Musée d'art contemporain de Lyon
          and supported by the interreg research program Effondrement des Alpes.
        </p>
      </div>
      <div
